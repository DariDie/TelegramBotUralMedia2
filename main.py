...
def start(message):
    ...
    bot.send_message(message.from_user.id, 'Привет!🔥 Судя по всему, ты собираешься в путешествие, но ещё определяешься с местом поездки. Предлагаю тебе путешествие в Ханты-Мансийский АО, а именно в город Нижневартовск, который превздоёт все твои ожидания ⬆', reply_markup=user_markup)
    bot.send_message(message.from_user.id, 'Выбери направления отдыха в меню ниже:')
