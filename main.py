...
def start(message):
    ...
    bot.send_message(message.from_user.id, 'Привет! 🔥 \nСудя по всему, ты собираешься в путешествие, но ещё определяешься с местом поездки 🤔 \nПредлагаю тебе путешествие в Ханты-Мансийский АО, а именно в город Нижневартовск, который превзойдёт все твои ожидания ⬆', reply_markup=user_markup)
...
def text(message):
    if message.text == 'Прогулки':
        ...
        bot.send_message(message.from_user.id, '1⃣ Набережная - самое популярное место для отдыха и прогулок 👍 Это своеобразная визитная карточка города, поскольку именно река Обь является его историческим началом 🌇 \n2⃣ Рябиновый бульвар - пешеходная улица, выполненная с различными архитектурными конструкциями и решением сохранения зелёного фонда 🌱 Кроме того, на бульваре можно увидеть представителей местной фауны - красавцев-снегирей 🥰\n3⃣ Парк победы - важное место для города и его истории. Внутри же него, помимо мемориала и скульптур, можно найти скромный, но не менее интересный парк аттракционов 🎯 \n4⃣ Граффити, которые ты сможешь встретить на своем маршруте. Говорят, на их фоне получаются самые удачные фото 🔥 ')
    ...
    if message.text == 'Еда':
        ...
        bot.send_photo(message.from_user.id, img,
                       'Для того, чтобы попробовать город на вкус и насладиться красивыми интерьерами, советую тебе следующие заведения⬆ \nP.S. Отметил там интересные граффити по пути, на их фоне красивые фотокарточки тебе обеспечены 😉  \nСсылка на маршрут: '
        ...
        bot.send_message(message.from_user.id,
                         '1⃣ "ТрактирЪ на Северной" — идеальное место для людей, любящих отдохнуть от души. Более 10 сортов свежего, вкуснейшего напитка, обширный ассортимент горячих блюд и всевозможных северных закусок не оставят равнодушным ни одного гостя! 😉 \n2⃣ Lounge cafe «Изба New» - новое пространство, где каждая минута обретает смысл🌱Место, где рождаются идеи, готовится вкусная еда, играет красивая музыка, встречаются любимые и друзья.🌱 Место, где человек как никогда близок к природе 🌱 \n3⃣ Ресторан-клуб « Золотой Медведь», историческое место в ХМАО, открытый  в  1997 году, с высокой кухней Севера. Это охотничий домик где гостям предлагают  насладится, лучшей в  Нижневартовске строганиной, закусками из дичи, рубаниной из рыбы, диким мясом и разнообразными настойками собственного приготовления 🔥 \n4⃣ Граффити, которые ты сможешь встретить на своем маршруте. Говорят, на их фоне получаются самые удачные фото 🔥 ')
